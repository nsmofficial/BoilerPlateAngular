...
@Component({
  selector: 'app-custome-date-picker',
  templateUrl: './custome-date-picker.component.html',
  styleUrls: ['./custome-date-picker.component.sass'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CustomeDatePickerComponent<D> implements  OnDestroy {
